...
type countriesFunctionsMappingType = {
  [key: string]: () => Promise<{ date: string; month: string; year: string }>;
};
export type countryKey = keyof countriesFunctionsMappingType;
export const countriesFunctionsMapping: countriesFunctionsMappingType = {
